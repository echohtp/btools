    ...
    <div className='container'>
      ...
      <div className='grid grid-flow-row'>
        {nft.creators.map((creator) => {
            ...
            return ( <div><h2 className='inline-block'>{creator.twitterHandle}&nbsp;&nbsp;</h2><p className='inline-block text-small'>({creator.address})</p></div>)
            else 
            return (<div><h2>{creator.address}</h2></div>)})}
      </div>
