      ...
      <div className='drawer-content'>
        <div className='container px-4'>
          <div className='w-full mb-4'>
            <input type="text" placeholder="Search..." className="w-[80%] input input-bordered input-secondary" onChange={(e)=>(setSearch(e.target.value))} />
            <button
                className='inline-block text-white btn btn-primary'
                onClick={()=>downloadFile(true)}
              >
                Get All
              </button>{sending.length > 0 ? <button onClick={()=>{
              //@ts-ignore  
